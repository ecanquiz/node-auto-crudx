...
export default {
  detailForm: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/formDetail`,
  ...
  detailServices: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/services/detail`,
    outputPath: `services`,
  ...
  detailTab: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/tabDetail`,
    outputPath: `components/${uCamelCase(singular(params.tableMaster))}`,
  ...
  detailTable: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/tableDetail`,
    outputPath: `components/${uCamelCase(singular(params.tableMaster))}`,
  ...
  detailTypes: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/types/detail`,
  ...
  detailUseForm: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/composables/useFormDetail`,
  ...
  detailUseTab: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/composables/useTabDetail`,
    outputPath: `composables/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterCreateOrEdit: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/views/createOrEditMaster`,
  ...
  masterFormCreateOrEdit: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/formCreateOrEditMaster`,
    outputPath: `components/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterForm: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/formMaster`,
    outputPath: `components/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterTab: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/components/tabMaster`,
    outputPath: `components/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterUseCreateOrEdit: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/composables/useCreateOrEdit`,
    outputPath: `composables/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterUseForm: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/composables/useFormMaster`,
    outputPath: `composables/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterUseTab: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/composables/useTabMaster`,
    outputPath: `composables/${uCamelCase(singular(params.tableMaster))}`,
  ...
  tabs: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${config.crud.stackFrontend}/templates/views/tabs`,
    outputPath: `views/${uCamelCase(singular(params.tableMaster))}`,
    outputFile: 'Tabs.vue',
    params
  })
