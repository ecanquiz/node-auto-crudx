...
export default {
  detailController: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/controllerDetail`,
  ...
  detailModel: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/modelDetail`,
    outputPath: `Entities`,
  ...
  detailRoute: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/routeDetail`,
    outputPath: `Routes`,
  ...
  detailStoreRequest: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/storeDetailRequest`,
  ...
  detailStoreService: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/storeDetailService`,
  ...
  detailUpdateRequest: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/updateDetailRequest`,
    outputPath: `Http/Requests/${uCamelCase(singular(params.tableDetailsCurrent!.tableName))}`,
  ...
  detailUpdateService: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/updateDetailService`,
    outputPath: `Http/Services/${uCamelCase(singular(params.tableDetailsCurrent!.tableName))}`,
  ...
  masterController: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/controller`,
    outputPath: `Http/Controllers`,
  ...
  masterModel: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/model`,
    outputPath: `Entities`,
  ...
  masterRequestStore: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/requestStore`,
  ...
  masterRequestUpdate: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/requestUpdate`,
    outputPath: `Http/Requests/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterResource: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/resource`,
  ...
  masterRoute: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/route`,
    outputPath: `Routes`,
  ...
  masterServiceIndex: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/serviceIndex`,
  ...
  masterServiceStore: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/serviceStore`,
    outputPath: `Http/Services/${uCamelCase(singular(params.tableMaster))}`,
  ...
  masterServiceUpdate: (params: ParamsAll): Rendering => ({
    template: `./src/stack/${crud.stackBackend}/templates/serviceUpdate`,
    outputPath: `Http/Services/${uCamelCase(singular(params.tableMaster))}`,
